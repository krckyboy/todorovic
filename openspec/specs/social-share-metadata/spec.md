# social-share-metadata Specification

## Purpose

Define consistent social-share metadata and OG card rules for the portfolio, including optimized default assets, blog-card CTA placement, and required OG/Twitter image tags.
