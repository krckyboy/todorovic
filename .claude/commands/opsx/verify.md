---
name: "OPSX: Verify"
description: Verify implementation matches change artifacts before archiving (spawns parallel agents per spec)
category: Workflow
tags: [workflow, verify, experimental, parallel]
---

Verify that an implementation matches the change artifacts (specs, tasks, design) by spawning parallel verification agents.
