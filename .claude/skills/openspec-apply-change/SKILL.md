...
description: Implement tasks from an OpenSpec change with inline spec verification. Use when the user wants to start implementing, continue implementation, or work through tasks.
license: MIT
